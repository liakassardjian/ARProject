//
//  ProgressoTableViewController.swift
//  testeSceneKit
//
...
class ProgressoTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "progresso", for: indexPath) as! ProgressoTableViewCell
